				...
				<div class="card-deck">
				  <div class="card border-dark mb-3 center">
				    <div class="card-body text-dark">
				      ...
				      <img src="views/dogs/img/add128.png" class="img-fluid mt-2 mb-2" alt="MyAwards">
				      <p class="card-text">Vytvorte profil pre vášho psíka a hneď môžete zadávať aj získané ocenenia</p>
				      <div class="center">
				        <a  href="dogs/create" class="btn btn-success">Kliknite sem</a>
				      </div>
				    </div>
				  </div>
				  <div class="card border-dark mb-3 center" >
				    <div class="card-body text-dark">
				      ...
				      <img src="views/dogs/img/dogs128.png" class="img-fluid mt-2 mb-2" alt="MyDogs">
				      <p class="card-text">Zoznam všetkých vašich psov v tabuľkovej forme.</p>
				      <div class="center">
				        <a class="btn btn-success" href="dogs/mydogs">Kliknite sem</a>
				      </div>
				    </div>
				  </div>
				  <div class="card border-dark mb-3 center">
				    <div class="card-body text-dark">
				      ...
				      <img src="views/dogs/img/profile128.png" class="img-fluid mt-2 mb-2" alt="MyDashboard">
